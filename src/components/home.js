  ...
  return (
    <Card className={classes.root} classes={{ root: "card_position" }}>
      ...
      <CardActions classes={{ root: "continue" }}>
        <Link to="/contact_me">
          <Button size="small">I'd love to work with you. Contact Me</Button>
        </Link>
      </CardActions>
    </Card>
  );
...
export default class Home extends React.Component {
  ...
  render() {
      ...
      content = (
        <div className="intro-card">
          ...
          <div className="apology_for_essay">
            <div className="apology_content">
              ...
              <div className="apology_para">
                <p>
                  Now that I got it out of the way, here are some of my
                  experiences
                </p>
              </div>
            </div>
          ...
          <div className="skills_container">
            <h3 className="skills_intro">
              I've picked up some skills throughout my experiences and projects{" "}
            </h3>
          </div>
        ...
        <div>
          ...
          <div className="passion_heading_container">
            ...
            <div className="obession_position">
              <h3 className="test_passion">
                Ive developed a{" "}
                <span className="obession">complete obssesion</span> for ...
              </h3>
            </div>
          </div>
    ...
    return <div className="home_container">{content}</div>;
  }
}
    ...
    <Card className={classes.root} classes={{ root: "introduction" }}>
      <CardContent>
        ...
        <Typography variant="body2" component="p">
          My name is Jacky Chen. I am currently a sophmore at Stony Brook
          University, pursuing a bachelors of science in computer science. My
          interst in computer science started my junior year at Brooklyn
          Technical High School. I was lucky enough to have the opportunity to
          be enrolled in the Ap Computer Science course at my school. It wasnt a
          month in when i realized that this was something I was extremely
          interested in.
          <br />
          <br />
          In the class, we had numerous projects that were assigned to us. One
          particular project involved creating something that allows a person to
          edit photos by altering the pixels and appling crazy styles to it. I
          was drawn in by the inovation and creativity that programing could
          bring out in a person. The ability to create something that could
          potentially be used by everyone really stuck with me. And the best
          thing? You dont need much to start; Just your drive to learning and
          your enthusiansm.
          <br />
          <br />
          After completing my first year at stony brook university, i knew this
          was the right path for me. My interests now span a wide range of
          fields within computer science, from data science and web development,
          to product management. While I am not sure which one is my favorite,
          as they all have their appeal, i know one thing's for sure. My drive
          for learning will never stop as there are limitless possibilities when
      ...
      <TimelineItem classes={{ root: "sbu" }}>
        ...
        <TimelineContent>
          ...
          >
            ...
            <Typography classes={{ root: "position" }}>
              Bachelors of Science in Computer Science August 2019 - Now (May
              2023)
            </Typography>
            <div className="rev_classes">
              ...
              <Typography>
                <ul>
                  ...
                  <li>
                    Applied Mathematics and Statistics: Applied Calculus 2
                  </li>
        ...
        <TimelineContent>
          ...
          >
            ...
            <Typography classes={{ root: "tasks" }}>
              <ul>
                <li>
                  Lead a group of 8 interns to devize a product to combat the
                  growing deaths of pregnant women in the United States. Focused
                  on the minority population.
                </li>
                <li className="second_task">
                  Utilized both frontend and backend technologies like ReactJs,
                  NodeJs, ExpressJS, and React Native to create both a web and
                  app platform to provide minority populations with easier
      ...
      <TimelineItem classes={{ root: "db" }}>
        ...
        <TimelineContent>
          ...
          >
            ...
            <Typography classes={{ root: "position" }}>
              IT Intern - Mark Schnidman, Tech Lead (March 2018 - September
              2018)
            </Typography>
            <Typography classes={{ root: "tasks" }}>
              <ul>
                <li>
                  Led 6 other interns in finding bids on office equipment like
                  computers, laptops, firewalls, monitors, and telephones for
                  the company.
                </li>
                <li className="second_task">
                  Reorganized the old cabling of the company, making sure that
                  the the hardware and software of the entire Brooklyn branch is
                  up to date and running efficiently.
                </li>
                <li>
                  Assisted the office with any technical difficulties that come
                  along, such as viruses and admin access to certain software in
                  the building.
                </li>
              </ul>
            </Typography>
      ...
      <TimelineItem classes={{ root: "fx" }}>
        ...
        <TimelineContent>
          ...
          >
            ...
            <Typography classes={{ root: "position" }}>
              Engineering Intern: ACE Mentorship (Spetember 2017 - March 2018)
            </Typography>
            <Typography classes={{ root: "tasks" }}>
              <ul>
                <li>
                  Collaborated with professional engineers to develop schematics
                  and floor plans involving the construction of an agricultural
                  school in Yabucoa,Puerto Rico.
                </li>
                <li className="second_task">
                  Stood in front of a panel of professional judges, some whom
                  were structural engineers, architects, and electrical
                  engineers. Responded to questions regarding the strength and
                  integrity of the building and whether or not it can hold in a
                  disastrous area like Yabucoa.
                </li>
              </ul>
            </Typography>
          </Paper>
  ...
  return (
    <div>
      <Button type="button" onClick={handleOpen} size="small">
        Learn More about my wellness journey
      </Button>
      <Modal
      ...
      <TimelineItem>
        ...
        <TimelineContent>
          ...
          >
            ...
            <Typography classes={{ root: "position" }}>
              IT Intern - Mark Schnidman, Tech Lead
            </Typography>
            <Typography classes={{ root: "tasks" }}>
              <ul>
                <li>
      ...
      <TimelineItem>
        ...
        <TimelineContent>
          ...
          >
            ...
            <Typography classes={{ root: "position" }}>
              Engineering Intern: ACE Mentorship
            </Typography>
            <Typography classes={{ root: "tasks" }}>
              <ul>
                <li>
